	...
	initValidation : function() {
		$('#formComponent').validate({
            ...
            errorPlacement : function(e, r) {
                $(r).addClass("is-invalid"), jQuery(r).parents(".form-group").append(e)
            }, 
            ...
            messages : {
            	"name": {
                    required: "Please enter a name", minlength: "Your name must consist of at least 3 characters"
                }
            }
        });
	}
