		                               ...
		                               <tbody>
		                               	   <c:forEach items="${roomTypeList}" var="roomTypeData">
													...
													<td class="text-center">
													   <input type="hidden" class="col-id" value="${roomTypeData.id}"/>
													   <input type="hidden" class="col-name" value="${roomTypeData.name}"/>
													   <input type="hidden" class="col-providerId" value="${roomTypeData.providerId}"/>
													   <input type="hidden" class="col-active" value="${roomTypeData.active}"/>
			                                           <div class="btn-group">
