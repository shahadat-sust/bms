...
<html lang="en">
    <head>
        <title>BMS - Booking Status Setup</title>
        <meta name="description" content="BMS - Booking Status Setup">
    ...
    <body>
             ...
             <div class="bg-body-light">
                 <div class="content content-full">
                     <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                         <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Booking Status Setup</h1>
            ...
            <div class="content">
                  ...
                  <div class="block block-rounded block-bordered">
						...
						<button id="btnCreateNew" type="button" class="btn btn-success mr-1">
                            <i class="fa fa-fw fa-plus mr-1"></i> Add Booking Status
                        </button>
                  	  </div>
                           ...
                           <table id="dataTable" class="table table-bordered table-striped table-vcenter">
                               ...
                               <tbody>
                               	   <c:forEach items="${bookingStatusList}" var="bookingStatusData">
											...
											<td>
												${bookingStatusData.remarks}
											</td>
											<td class="text-center">
											   <input type="hidden" class="col-id" value="${bookingStatusData.id}"/>
											   <input type="hidden" class="col-name" value="${bookingStatusData.name}"/>
											   <input type="hidden" class="col-remarks" value="${bookingStatusData.remarks}"/>
	                                           <div class="btn-group">
		...
		<script type="text/javascript">
			...
			bookingStatusSetup.updateUrl = '<c:url value="/bookingstatus/update" />';
			bookingStatusSetup.deleteUrl = '<c:url value="/bookingstatus/delete/" />';
		</script>
    </body>
</html>