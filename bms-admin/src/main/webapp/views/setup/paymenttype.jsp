...
<html lang="en">
    <head>
        <title>BMS - Payment Type Setup</title>
        <meta name="description" content="BMS - Payment Type Setup">
    ...
    <body>
             ...
             <div class="bg-body-light">
                 <div class="content content-full">
                     <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                         <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Payment Type Setup</h1>
            ...
            <div class="content">
                  ...
                  <div class="block block-rounded block-bordered">
						...
						<button id="btnCreateNew" type="button" class="btn btn-success mr-1">
                            <i class="fa fa-fw fa-plus mr-1"></i> Add Payment Type
                        </button>
                  	  </div>
                      <div class="block-content">
                           <table id="dataTable" class="table table-bordered table-striped table-vcenter">
                               ...
                               <tbody>
                               	   <c:forEach items="${paymentTypeList}" var="paymentTypeData">
                               	   		<tr>
                               	   			<td class="font-w600">
												${paymentTypeData.id}
											</td>
											...
											<td>
												${paymentTypeData.remarks}
											</td>
											<td class="text-center">
											   <input type="hidden" class="col-id" value="${paymentTypeData.id}"/>
											   <input type="hidden" class="col-name" value="${paymentTypeData.name}"/>
											   <input type="hidden" class="col-remarks" value="${paymentTypeData.remarks}"/>
	                                           <div class="btn-group">
        ...
        <!-- Page JS Code -->
        <script src="<c:url value="/resources/js/custom/setup/paymenttype.js"/>"></script>   
		<script type="text/javascript">
			paymentTypeSetup.fetchUrl = '<c:url value="/paymenttype/fetch/" />';
			paymentTypeSetup.createUrl = '<c:url value="/paymenttype/create" />';
			paymentTypeSetup.updateUrl = '<c:url value="/paymenttype/update" />';
			paymentTypeSetup.deleteUrl = '<c:url value="/paymenttype/delete/" />';
		</script>
    </body>
</html>