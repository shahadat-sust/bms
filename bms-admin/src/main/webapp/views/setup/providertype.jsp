...
<html lang="en">
    <head>
        <title>BMS - Provider Type Setup</title>
        <meta name="description" content="BMS - Provider Type Setup">
    ...
    <body>
             ...
             <div class="bg-body-light">
                 <div class="content content-full">
                     <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                         <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Provider Type Setup</h1>
            ...
            <div class="content">
                  ...
                  <div class="block block-rounded block-bordered">
						...
						<button id="btnCreateNew" type="button" class="btn btn-success mr-1">
                            <i class="fa fa-fw fa-plus mr-1"></i> Add Provider Type
                        </button>
                  	  </div>
                      <div class="block-content">
                           <table id="dataTable" class="table table-bordered table-striped table-vcenter">
                               ...
                               <tbody>
                               	   <c:forEach items="${providerTypeList}" var="providerTypeData">
                               	   		<tr>
                               	   			<td class="font-w600">
												${providerTypeData.id}
											</td>
											<td class="font-w600">
												${providerTypeData.name}
											</td>
											<td>
												${providerTypeData.remarks}
											</td>
											<td class="text-center">
											   <input type="hidden" class="col-id" value="${providerTypeData.id}"/>
											   <input type="hidden" class="col-name" value="${providerTypeData.name}"/>
											   <input type="hidden" class="col-remarks" value="${providerTypeData.remarks}"/>
	                                           <div class="btn-group">
		...
		<script type="text/javascript">
			...
			providerTypeSetup.updateUrl = '<c:url value="/providertype/update" />';
			providerTypeSetup.deleteUrl = '<c:url value="/providertype/delete/" />';
		</script>
    </body>
</html>