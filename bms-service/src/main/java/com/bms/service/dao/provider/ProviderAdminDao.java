		...
		try {
			...
			List<ProviderAdminData> providerList = this.getTemplete().query(sql, params, new RowMapper<ProviderAdminData> () {
				...
				public ProviderAdminData mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					providerAdminData.setProviderTypeId(rs.getLong(4));
					providerAdminData.setTitle(rs.getString(5));
					providerAdminData.setStarRating(rs.getInt(6));
					providerAdminData.setUsername(rs.getString(7));
					providerAdminData.setFirstName(rs.getString(8));
					providerAdminData.setLastName(rs.getString(9));
					providerAdminData.setAddress(rs.getString(10));
					providerAdminData.setCityName(rs.getString(11));
					providerAdminData.setStateName(rs.getString(12));
					providerAdminData.setCountryName(rs.getString(13));
		...
		try {
			...
			List<ProviderAdminData> providerAdminList = this.getTemplete().query(sql, params, new RowMapper<ProviderAdminData> () {
				...
				public ProviderAdminData mapRow(ResultSet rs, int rowNum) throws SQLException {
					...
					providerAdminData.setAddress(rs.getString(10));
					providerAdminData.setCityName(rs.getString(11));
					providerAdminData.setStateName(rs.getString(2));
					providerAdminData.setCountryName(rs.getString(13));
					return providerAdminData;
				}	
			});
