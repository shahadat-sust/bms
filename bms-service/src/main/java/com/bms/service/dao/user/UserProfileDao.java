	...
	public long create(UserProfileData userProfileData) throws BmsSqlException {
		...
		this.getTemplete().update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(Connection conn) throws SQLException {
				...
				ps.setDate(11, new java.sql.Date(userProfileData.getCreatedOn().getTime()));
				ps.setLong(12, userProfileData.getUpdatedBy());
				ps.setDate(13, new java.sql.Date(userProfileData.getUpdatedOn().getTime()));
				return ps;
			}
		}, holder);
